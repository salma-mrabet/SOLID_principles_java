...
public class EmployeeFormatter {
	...
	public String toHtml() {
		String str = "<div>" + "<h1>Employee Info</h1>" + "<div id='emp" + _employee.getEmpId() + "'>" + "<span>"
				+ _employee.getName() + "</span>" + "<div class='left'>" + "<span>Leaves Left :</span>"
				+ "<span>Annual salary:</span>" + "<span>Manager:</span>" + "<span>Reimbursable leaves:</span>"
				+ "</div>";
